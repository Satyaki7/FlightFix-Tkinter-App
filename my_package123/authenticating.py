...
#         host="localhost",
#         user="root",  # Adjust according to your MySQL credentials
#         password="bbit@123",  # Adjust to your password
#         database="flightfix"  # Adjust to your database
#     )
...
#     cursor.executemany('''
#     INSERT INTO Cities (Mumbai, Delhi, Bangalore, Hyderabad, Chennai, Kolkata, London, Paris, Tokyo, Sydney, Dubai, NewYork, Srinagar, Kochi, Kyoto, Jaipur, Time) 
